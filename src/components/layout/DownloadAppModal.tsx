...
// Intel Mac build (Shwe.Pha.La.POS-1.0.3.dmg) is still published in the
// release for anyone who needs it directly, just not offered here — every
// Mac sold since 2020 is Apple Silicon.
const DOWNLOADS = {
  macArm: `${RELEASE_BASE}/Shwe.Pha.La.POS-1.0.3-arm64.dmg`,
  windows: `${RELEASE_BASE}/Shwe.Pha.La.POS.Setup.1.0.3.exe`,
};
